...
export function Navbar({ currentPage, onNavigate, onLogin, isLoggedIn }: NavbarProps) {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item, index) => (
              ...
              >
                ...
                {/* Hover indicator */}
                <motion.div
                  className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full"
                  whileHover={{ 
                    width: "80%",
                    x: "-50%"
                  }}
          ...
          <div className="flex items-center space-x-4">
            {!isLoggedIn && (
              <motion.button
                onClick={onLogin}
                className="relative group bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full font-medium shadow-lg overflow-hidden"
